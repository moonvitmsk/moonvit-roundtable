...
export default function App() {
  ...
  if (session) {
    return <SessionView session={session} onBack={handleBack} />;
  }
          ...
          <button
            onClick={() => {
              setSelectedTemplate({
                ...
                icon: "🎛️",
                agents: [
                  { id: "agent-1", name: "Эксперт 1", role: "Опишите роль", systemPrompt: "Опишите поведение агента...", avatar: "🧠", color: "#6366f1", expertise: ["экспертиза"] },
                  { id: "agent-2", name: "Эксперт 2", role: "Опишите роль", systemPrompt: "Опишите поведение агента...", avatar: "🎯", color: "#10b981", expertise: ["экспертиза"] },
                  { id: "provocateur", name: "Провокатор", role: "Стресс-тест идей", systemPrompt: "Ты — Devil's Advocate. Разрушаешь консенсус. Если все согласны — находишь изъяны. Всегда предлагаешь контринтуитивную альтернативу.", avatar: "😈", color: "#ef4444", expertise: ["критика", "риски"] },
                ],
